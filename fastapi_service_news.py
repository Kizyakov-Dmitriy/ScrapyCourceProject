...
async def get_mongo_db() -> AsyncCollection[Mapping[str, Any] | Any]:
    ...
    mongo_db = getenv("MONGO_DATABASE", "scrape_catalog")
    mongo_db_collection = getenv("MONGO_DATABASE_COLLECTION", "news")
...
async def get_random_articles_in_html(
    ...
    html_content = """
        ...
        <body>
            ...
            <h3>Мы собрали для тебя новости с сайта новостей, чтобы ты мог читать новости в перерывах между тем, как читаешь новости</h3>
        """
